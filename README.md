...
| 21 | Merge Two Sorted Lists | Easy | Linked List, DFS | [lc_0021_merge_two_sorted_list.py](solutions/s12_dfs/lc_0021_merge_two_sorted_list.py) | O(m+n) | O(m+n) |
...
| 323 | Number of Connected Components in an Undirected Graph | Medium | Union-Find | [lc_0323_number_of_connected_components_in_an_undirected_graph.py](solutions/s14_union_find/lc_0323_number_of_connected_components_in_an_undirected_graph.py) | O(e * α(v)) | O(v) |
...
| 406 | Queue Reconstruction by Height | Medium | Greedy | [lc_0406_queue_reconstruction_by_height.py](solutions/s07_greedy/lc_0406_queue_reconstruction_by_height.py) | O(n^2) | O(n) |
...
| 547 | Number of Provinces | Medium | Union Find | [lc_0547_number_of_provinces.py](solutions/s14_union_find/lc_0547_number_of_provinces.py) | O(n^2) | O(n) |
...
| 684 | Redundant Connection | Medium | Union Find | [lc_0684_redundant_connection.py](solutions/s14_union_find/lc_0684_redundant_connection.py) | O(n) | O(n) |
| 690 | Employee Importance | Medium | BFS | [lc_690_employee_importance.py](solutions/s11_bfs/lc_690_employee_importance.py) | O(n) | O(n) |
| 695 | Max Area of Island | Medium | Grid, DFS | [lc_0695_max_area_of_islands.py](solutions/s12_dfs/lc_0695_max_area_of_islands.py) | O(m * n) | O(m * n) recursion stack |
...
| 994 | Rotting Oranges | Medium | BFS | [lc_0994_rotting_orange.py](solutions/s11_bfs/lc_0994_rotting_orange.py) | O(m*n) | O(m*n) |
| 997 | Find the Town Judge | Easy | Graph | [lc_0997_find_the_town_judge.py](solutions/s10_graph/lc_0997_find_the_town_judge.py) | O(n) | O(n) |
...
| 1042 | Flower Planting With No Adjacent | Medium | Graph | [lc_1042_flower_planting_with_no_adjacent.py](solutions/s10_graph/lc_1042_flower_planting_with_no_adjacent.py) | O(n+m) | O(n+m) |
